...
hold data plus a string `name`. `NamedColumn`s are only ever
...
to facilitate use in a "fluent" style. It makes it much easier to
write iteration over objects and collect the results if everyone
